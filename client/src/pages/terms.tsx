        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-white/70 leading-relaxed text-sm">
            <section>
              ...
              <p>By adding Hiyori to your Discord server or interacting with Hiyori in any way, you agree to these Terms of Service. If you do not agree, please remove Hiyori from your server and discontinue use.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">2. Description of Service</h2>
              <p>Hiyori is an AI-powered Discord bot that provides conversational AI features, a virtual economy (gems and gold), and a gacha (character collection) system. Features include:</p>
            ...
            <section>
              ...
              <p className="mb-3">Hiyori uses two virtual currencies: <strong className="text-white">Gems (💎)</strong> and <strong className="text-white">Gold (🪙)</strong>.</p>
              <ul className="space-y-1.5 list-disc list-inside text-white/60">
                <li>Gems are used to send messages to Hiyori. Free gems are earned via daily rewards and voting.</li>
            ...
            <section>
              ...
              <p>You agree not to use Hiyori to:</p>
              <ul className="mt-3 space-y-1.5 list-disc list-inside text-white/60">
                ...
                <li>Use automated tools or bots to interact with Hiyori</li>
            ...
            <section>
              ...
              <p>Anime character data displayed through the gacha system is sourced from AniList (anilist.co) and is the property of their respective owners. Hiyori does not claim ownership of any character intellectual property. Character images are sourced from AniList's API under their terms of use.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">6. Service Availability</h2>
              <p>We provide Hiyori on an "as is" and "as available" basis. We do not guarantee uninterrupted service. We reserve the right to modify, suspend, or discontinue Hiyori at any time without notice. We are not liable for any loss resulting from service interruptions.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">7. Termination</h2>
              <p>We may terminate or restrict your access to Hiyori at any time, for any reason, including violations of these terms. You may stop using Hiyori at any time by removing it from your server.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">8. Limitation of Liability</h2>
              <p>To the fullest extent permitted by law, we shall not be liable for any indirect, incidental, special, or consequential damages arising from your use of Hiyori, including loss of virtual currency, content, or data.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">9. Changes to Terms</h2>
              <p>We may update these terms at any time. Continued use of Hiyori after changes constitutes acceptance of the updated terms. We will announce major changes in our support server.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">10. Contact</h2>
              <p>For questions about these terms, contact us via Hiyori's Discord support server or through her top.gg listing.</p>
            </section>
          </div>
        </div>
      </main>

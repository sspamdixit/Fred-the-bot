          ...
          >
            <div className="space-y-3">
              ...
              <div className="rounded-xl px-3 py-2 flex items-start gap-2 text-xs" style={{ background: "rgba(56,189,248,0.06)", border: "1px solid rgba(56,189,248,0.15)", color: "rgba(255,255,255,0.5)" }}>
                ...
                Bot commands: <code className="mx-1">?ping</code> <code className="mx-1">?status</code> <code className="mx-1">?info</code> <code className="mx-1">?help</code> <code className="mx-1">?fred &lt;msg&gt;</code>
              </div>
            </div>
          </DiagSection>

        ...
        <div className="max-w-3xl mx-auto">
          ...
          <div className="space-y-10 text-white/70 leading-relaxed text-sm">
            ...
            <section>
              ...
              <ul className="mt-3 space-y-1.5 list-disc list-inside text-white/60">
                <li>To provide AI conversation features (Kira's responses and memory)</li>
            ...
            <section>
              ...
              <p>Kira uses third-party AI providers (Google Gemini, Groq) to generate responses. Messages sent to Kira may be transmitted to these providers for processing. Please review their privacy policies:</p>
              <ul className="mt-3 space-y-1.5 list-disc list-inside text-white/60">
            ...
            <section>
              ...
              <p>Your data is stored for as long as you actively use Kira. Conversation context is kept for AI memory purposes. You can request deletion of your data at any time by contacting us (see Section 7). Economy data (gems, gold, collection) is retained as it represents your in-app progress.</p>
            </section>
            ...
            <section>
              ...
              <p>Kira is not directed at children under 13. If you are under 13, please do not use this service. Discord itself requires users to be at least 13 years old.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">7. Your Rights</h2>
              <p>You may request access to, correction of, or deletion of your personal data at any time. To exercise these rights, contact us via the support server linked in Kira's profile on Discord or top.gg.</p>
            </section>

            <section>
              <h2 className="text-white text-base font-semibold mb-3">8. Changes to This Policy</h2>
              <p>We may update this policy from time to time. Continued use of Kira after changes constitutes acceptance of the updated policy. Major changes will be announced in our support server.</p>
            </section>
          </div>
        </div>
      </main>

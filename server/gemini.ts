  ...
  void (async () => {
    try {
      ...
      const systemPrompt = [
        ...
        "CRITICAL: when something is promoted to Sureties, DELETE it from Possibilities. The two tiers must NEVER contain overlapping information. Possibilities is for unconfirmed inferences only; once confirmed, it lives in Sureties alone.",
